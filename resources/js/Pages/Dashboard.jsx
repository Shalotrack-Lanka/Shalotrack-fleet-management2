...
export default function Dashboard() {
    ...
    // Fetch vehicle data when the component loads
    useEffect(() => {
        const fetchVehicles = async () => {
            try {
                // Calling your Laravel API endpoint
                    ...
                    <div className="p-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
                        ...
                        {loading ? (
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                                ...
                                <p className="font-semibold text-gray-800 text-lg">{demoVehicle.vehicle_name || 'Toyota Prius (Demo)'}</p>
                                <p className="text-sm text-gray-500 mt-1">Number Plate: {demoVehicle.number_plate || 'WP CAA-1234'}</p>
